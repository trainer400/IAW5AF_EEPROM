...
6. **Parse the output:**
    - Open the your serial monitor and reset the board while connected;
    - You should see the following output:<br/>
        ```
        Start EEPROM Reading!
        ...
        ...
        ```
    - After the whole operation finishes (I.e. when the address arrives to the 0x07ff value (2KB of memory)) and restarts automatically, close the connection and save the dump;
    - Remove the init text and leave only the addresses and their value with the following format: 0xXXXX -> 0xXX;
    - Use the provided eeprom_parser.py script to convert the text file into a bin file that represents the EEPROM content with the following command:
        ```console
        python3 eeprom_parser.py <file_name>
        ```
    - Now you should have your EEPROM file!